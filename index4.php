...
<body>
        ...
        <div class="hero-slide" style="background-image: url('https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');">
            <div class="container">
                <div class="hero-content">
                    ...
                    <a href="#" class="hero-btn">Get Started Today</a>
                </div>
            </div>
        </div>
    ...
    <section class="mda-section">
        <div class="container">
            <div class="section-title">
                <h2>Ministries, Departments & Agencies</h2>
            </div>
            
            <div class="mda-slider" id="mdaSlider">
                <!-- MDA cards will be dynamically generated here -->
            </div>
        </div>
    </section>
    ...
    <section class="news-section">
        <div class="container">
            ...
            <div class="news-grid">
                <div class="news-card">
                    <div class="news-image" style="background-image: url('https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80');"></div>
                ...
                <div class="news-card">
                    <div class="news-image" style="background-image: url('https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80');"></div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image" style="background-image: url('https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80');"></div>
                    <div class="news-content">
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-buttons">
                    <a href="login.php" class="cta-btn cta-btn-primary"><i class="fas fa-user-plus"></i> Create Your Account</a>
                    <a href="login.php" class="cta-btn cta-btn-secondary"><i class="fas fa-play-circle"></i> Watch Demo</a>
                </div>
            </div>
        </div>
    </section>
        ...
        const mdas = [
            {
                ...
                description: "Overseeing urban development, physical planning, and building regulations across Ekiti State to ensure sustainable growth."
            },
            {
                name: "Ekiti State Signage and Advertisement Agency",
                description: "Regulating and managing outdoor advertisements, signs, and hoardings throughout the state for orderly urban aesthetics."
            },
            {
                name: "Ministry of Infrastructure and Public Utilities",
                description: "Responsible for infrastructure development and maintenance of public utilities to enhance quality of life."
            },
            {
                name: "Ministry of Trade, Industry, Investment & Cooperatives",
                description: "Promoting trade, industrial growth, investment opportunities, and cooperative societies for economic development."
            },
            {
                name: "Ekiti State Environmental Protection and Watershed Management Agency",
                description: "Protecting the environment and managing watershed resources for sustainable development and conservation."
            },
            {
                name: "Ekiti State Bureau of Land Services",
                description: "Managing land administration, titles, and transactions across Ekiti State with transparency and efficiency."
            },
            {
                name: "Ekiti State Development and Investment Promotion Agency (EKDIPA)",
                description: "Promoting economic development and facilitating investments in Ekiti State to drive growth and prosperity."
            },
            {
                name: "Ekiti State Health Insurance Scheme",
                description: "Providing accessible and affordable healthcare through comprehensive insurance coverage for all citizens."
            },
            {
                name: "Ekiti State House of Assembly",
                description: "Legislative arm of the Ekiti State Government responsible for lawmaking and democratic governance."
            },
            {
                name: "Ekiti State Micro Credit Agency",
                description: "Providing micro-credit facilities to support small businesses and entrepreneurs for economic empowerment."
            },
            {
                name: "Job Creation and Employment Agency",
                description: "Facilitating job creation, employment opportunities, and skills development for Ekiti State residents."
            }
        ];

        // Function to generate MDA cards
        function generateMDACards() {
            const mdaSlider = document.getElementById('mdaSlider');
                ...
                card.innerHTML = `
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions">
                            <a href="#" class="card-btn card-login">Login</a>
                            <a href="#" class="card-btn card-register">Register</a>
                        </div>
                    </div>
                `;
                
                mdaSlider.appendChild(card);
            });
        }
